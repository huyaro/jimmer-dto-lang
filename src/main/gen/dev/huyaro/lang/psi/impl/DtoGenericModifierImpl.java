...
public class DtoGenericModifierImpl extends ASTWrapperPsiElement implements DtoGenericModifier {

  public DtoGenericModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DtoVisitor visitor) {
    visitor.visitGenericModifier(this);
  }
