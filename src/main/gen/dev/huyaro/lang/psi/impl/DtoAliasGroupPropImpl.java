...
public class DtoAliasGroupPropImpl extends ASTWrapperPsiElement implements DtoAliasGroupProp {

  public DtoAliasGroupPropImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DtoVisitor visitor) {
    visitor.visitAliasGroupProp(this);
  }
