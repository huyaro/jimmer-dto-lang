...
public class DtoNestedAnnotationImpl extends ASTWrapperPsiElement implements DtoNestedAnnotation {

  public DtoNestedAnnotationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DtoVisitor visitor) {
    visitor.visitNestedAnnotation(this);
  }
